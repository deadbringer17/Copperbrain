...
and validation report, rerun `validate_project_creation`, then explicitly confirm
`apply_project_creation`. The target directory may contain only Copperbrain's preview output;
